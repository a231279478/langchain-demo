...
from Tool.mail_tool import SendMailTool,EmailAddressTool,AddressBookTool
...
print(agent.from_agent_and_tools(agent,tools))
# 执行代理
print(agent.run("把张念驰,保存通讯录"))
